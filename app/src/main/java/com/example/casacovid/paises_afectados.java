...
public class paises_afectados extends AppCompatActivity {
    ...
    private void fetchData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            myCustomAdapter = new MyCustomAdapter(paises_afectados.this,countryModelsList);
            ...
            public void onErrorResponse(VolleyError error) {
                simpleArcLoader.stop();
                simpleArcLoader.setVisibility(View.GONE);
                Toast.makeText(paises_afectados.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
